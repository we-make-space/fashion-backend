...
router.get("/all", logAction("Fetching all sellers"), getAllSeller);
...
router.get("/SellerOrders/:email", logAction("Fetching all seller orders"), getAllSellerOrders,	logError);

router.get("/sellerOrderById/:id", logAction("Fetching all seller orders by id"), getSellerOrderById,	logError);
