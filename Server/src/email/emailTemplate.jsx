			...
			>
				...
				<Section className=" bg-[#ECE9E9] p-4 py-6 rounded-md">
					...
					<Section className=" text-center">
						...
						<Text className=" text-[14px]  text-gray-500">
							Great news! Your order is all set to hit the road. We're packing it up with care and it'll
				...
				<Section>
					<Container className=" bg-[#ECE9E9] rounded-md p-4 ">
						<Text className=" text-center text-[16px]  font-bold">Your item in this order</Text>
						...
						<Container className=" mt-2 bg-white text-[16px]  p-2 rounded-md">
							<Row className="mb-4">
								...
								<Column className="text-right ">$25</Column>
							</Row>
							<Row>
								<Column className="">Delivery Fee</Column>
								<Column className="text-right">$123</Column>
							</Row>
						</Container>
						<Container className=" mt-2 bg-white text-[16px]  p-2 rounded-md">
							<Row>
								<Column className="font-bold">Total</Column>
								<Column className="text-right font-bold">${order?.totalAmount}</Column>
							</Row>
						</Container>
					</Container>
				</Section>
